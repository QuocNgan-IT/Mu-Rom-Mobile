    ...
    <body>
        ...
        <table style="width: 100%; height: 50px; background: #B51E1E; text-align: center; font-size: 35px; color: white;">
            <tr>
                ...
                <td>
                    <?php include("../tim_kiem/thanh_tim_kiem.php"); ?>
                </td>
                <td align="right">
                    <?php
                        if (!isset($_SESSION['xac_dinh_dang_nhap']) or $_SESSION['xac_dinh_dang_nhap']=="khong") {
                            ...
                            if ($_SESSION['xac_dinh_dang_nhap'] == "co") {
                                echo "<input type=button onClick=window.open('../dang_nhap/dang_xuat.php'); value='Đăng xuất'>";
                            }
                        }
                    ?>
                </td>
                ...
                <tr>
                    ...
                    <td>
                        <table width="80%" height="90%" style="background: white;">
                            ...
                            <tr>
                                <td colspan="2">
                                    <input style="width: 100%;" type="password" id="password" name="password" placeholder="Nhập mật khẩu" pattern="^([a-zA-Z])[a-zA-Z0-9]{5,}" title="Tối thiểu 5 ký tự từ a-Z và 0-9, ký tự đầu tiên không phải số" onkeyup='check();' required>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <input style="width: 100%;" type="password" id="confirmPassword" name="confirmPassword" placeholder="Nhập lại mật khẩu" onkeyup='check();' required>
                                    <!-- <br>
                        <span id='message'>Check</span> -->
                            ...
                            <tr>
                                <td colspan="2">
                                    <input style="width: 100%;" type="email" name="email" pattern="^[a-zA-Z0-9.]+@[a-zA-Z0-9.-]+\.[a-zA-Z]{2,4}$" placeholder="Nhập địa chỉ email" required>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <input style="width: 100%;" type="text" name="phonenumber" placeholder="Nhập số điện thoại" title="Tối thiểu 10 chữ số" required>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    <input type="submit" name="btnRegister" style="background: #B51E1E; color: white;" value="Đăng ký">
                                    <br>
                                    <p id="return"></p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" align="center">
                                    ...
                                    <div>Bạn đã có tài khoản tại Mũ Rơm Mobile?<br><a href="../dang_nhap/dang_nhap.php"
