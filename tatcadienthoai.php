                                ...
                                ?>
                                    <div class="form-group">
                                        ...
                                        <label for="hang-<?php echo $row_hangdt['MaHang'] ?>" class="form-check-label dark-grey-text" onclick="locsp()">
                                            <h6 style="color: #4f4f4f;font-weight:bold"><?php echo $row_hangdt['TenHang'] ?>
                                            </h6>
                                        </label>
                                    </div>
                                <?php
                                            ...
                                            <div class="view overlay">
                                                <div class="dienthoai02">
                                                    <div class="tab-pane fade show in active" id="panel31" role="tabpanel">
                                                        ...
                                                        <h5 style="margin-left: 10px;font-size: 18px;font-weight: bold;margin-top: -30px">
                                                            <?php echo $row_tt['TenDT'] ?></h5>
                                                        <?php
                                                        ...
                                                        <div class="row" style="width: 100%;">
                                                            <div class="col-sm-7 gia gia-dt">
                                                                <p>&nbsp;&nbsp;<?php echo number_format($row_tt['GiaKhuyenMai'], 0, "", ".") ?>đ
                                                                </p>
                                                            </div>
                                                            <?php
                                                            ...
                                                            ?>
                                                                <div class="col-sm-5 gia giagoc-dt">
                                                                    <p class="">
                                                                        <del><?php echo number_format($row_tt['GiaGoc'], 0, "", ".") ?>đ</del>
                                                                    </p>
                                                                </div>
                                                            <?php
                                                            }
                                                        ...
                                                        <div style="position:relative">
                                                            <ul class="rating" style="margin-left: 15px;">
                                                                ...
                                                                ?>
                                                                <p style="position:absolute; right: 88px; bottom: -10px;font-size: 14px; color: black">
                                                                    (<?php
                                                            ...
                                                            <p style="position:absolute; right: 15px; bottom: -10px; font-size: 14px; color: black">
                                                                Đã bán: <b style="color: red">
    ...
    function locsp02() {
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                document.getElementById("locsp").innerHTML = (this
                    .responseText); //=>kết quả trả về thêm vào element này, có html vẫn hiện được
            }
        };
