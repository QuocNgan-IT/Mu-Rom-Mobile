...
<script>
    ...
    $("#anhIndex-them").change(function(e) {
        e.preventDefault();

        var files = document.getElementById("anhIndex-them").files;
        var formData = new FormData();
        formData.append("anhIndex-them", files[0]);
    ...
    $("#anhDT-them").change(function(e) {
        e.preventDefault();

        var files = document.getElementById("anhDT-them").files;
        var formData = new FormData();
        formData.append("anhDT-them", files[0]);
        ...
        <div class="list-personnel">
            ...
            <form action="">
                ...
                <div class="row form-item justify-content-between">
                    ...
                    <div class="col-4">
                        <button type="button" class="form-submit">
                            <label for="anhIndex-them">Thêm ảnh đại diện sản phẩm</label>
                        </button>
                        <input id="anhIndex-them" name="anhIndex-them" type="file" style="display:none;" accept="image/*">
                    </div>
                    <!-- Nút thêm ảnh sp -->
                    <div class="col-6">
                        <button type="button" class="form-submit">
                            <label for="anhDT-them">Thêm ảnh sản phẩm</label>
                        </button>
                        <input id="anhDT-them" type="file" style="display:none;" accept="image/*">
                    </div>                    
                </div>
                <!-- Line 2 -->
                ...
                <div class="row form-item justify-content-between">
                    ...
                    <!-- Giá -->
                    <div class="col-1">
                        <label for="gia-them" class="form-lable">Giá: </label>
                    </div>
                    <div class="col-2">
